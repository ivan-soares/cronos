...
#
	...
	nhrs_roms=`echo $ndays 24 $his_dh | awk '{print $1*$2/$3 + 1}'`
	...
	###### when using era5 remember that files are separated by variables and are named in ocean.in
	romsfrc="$casedir/force/d-storage/atmos_era5/force_${domain_wind}_${yr}_${wind}_03h.nc" # force file for roms

	romsclm="$casedir/clim/d-storage/input_clm_${domain_roms}_${version}_${yr}0101_${ogcm}_365d_24h_fixed.nc" # clim file for roms
	romsbry="$casedir/clim/d-storage/input_bry_${domain_roms}_${version}_${yr}0101_${ogcm}_365d_24h_fixed.nc" # bdry file for roms
